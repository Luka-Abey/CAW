  ...
  <>
    ...
    <div className="main-content-container">
      ...
      <div className="text-wrapper">
        <p>Community Action on Waste is a Leeds-based community co-operative, made up of local residents, alumni, and students. Every June, hundreds of tonnes of waste is left on the streets of Leeds. The kind of things left are exactly the kind of things incoming students will be buying new in September. We want this to end.
        <br/>
        <br/>
